              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ToggleRow(
                      key: const Key('tune-kenburns'),
                      title: 'Ken Burns ズーム',
                      subtitle: 'SLOW ZOOM',
                      value: s.kenBurns,
                      onChanged: (v) => update(s.copyWith(kenBurns: v)),
                    ),
                    SegmentedRow<int>(
                      title: 'おやすみタイマー',
                      subtitle: 'SLEEP — 画面を暗転',
                      value: s.sleepMinutes,
                      options: const [
                        SegmentedOption(0, 'OFF'),
                        SegmentedOption(15, '15分'),
                        SegmentedOption(30, '30分'),
                      ],
                      onChanged: (v) => update(s.copyWith(sleepMinutes: v)),
                    ),
                  ],
                ),
              ),
